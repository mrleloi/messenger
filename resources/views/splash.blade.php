    ...
    <div class="pt-5">
        <div class="container">
            ...
            <div class="col-12 text-center">
                ...
                <button onclick="window.location.href=''" type="button" class="d-none d-sm-inline shadow-lg btn btn-circle btn-circle-xl btn-info">New? <i class="fas fa-user-check"></i></button>
                <a class="d-block d-sm-none btn btn-lg btn-info" href="">Sign Up <i class="fas fa-user-plus"></i></a>
            </div>
        </div>
    </div>
    @include('demo')
