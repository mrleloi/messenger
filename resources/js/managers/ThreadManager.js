window.ThreadManager = (function () {
    ...
    Imports = {
        newMessage : function(data){
            console.log('imnports.newMessage');
    ...
    methods = {
        ...
        sendMessage : function(){
            ...
            if(message_contents.trim().length) {
                ...
                Messenger.xhr().payload({
                    ...
                    data : formData,
                    success : function(x){
                        methods.managePendingMessage('wait', pending, x);
                    },
                    fail : function(){
        ...
        managePendingMessage : function(action, pending, final){
            console.log('managePendingMessage');
            console.log(action);
            console.log(pending);
            console.log(final);
            ...
            switch (action) {
                case 'add':
                    console.log('managePendingMessage.add');
                ...
                break;
                case 'wait':
                    console.log('managePendingMessage.wait');
                    console.log(final);
                    // msg_elm.remove();
                    ...
                    break;
                case 'completed':
                    console.log('managePendingMessage.completed');
                    console.log(final);
                    msg_elm.remove();
                    if(storage.found) opt.storage.pending_messages.splice(storage.index, 1);
                    methods.addMessage(final);
