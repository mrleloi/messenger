...
use App\Jobs\SetupNewSystemMessage;
use Illuminate\Events\Dispatcher;
use App\Events\BotArchivedEvent;
use App\Events\BotAvatarEvent;
use App\Events\BotUpdatedEvent;
use App\Events\CallEndedEvent;
use App\Events\DemotedAdminEvent;
use App\Events\InviteUsedEvent;
use App\Events\NewBotEvent;
use App\Events\PackagedBotInstalledEvent;
use App\Events\ParticipantsAddedEvent;
...
use App\Jobs\BotAddedMessage;
use App\Jobs\BotAvatarMessage;
use App\Jobs\BotInstalledMessage;
use App\Jobs\BotNameMessage;
use App\Jobs\BotRemovedMessage;
use App\Jobs\CallEndedMessage;
use App\Jobs\DemotedAdminMessage;
use App\Jobs\JoinedWithInviteMessage;
use App\Jobs\ParticipantsAddedMessage;
use App\Jobs\PromotedAdminMessage;
use App\Jobs\RemovedFromThreadMessage;
use App\Jobs\ThreadArchivedMessage;
use App\Jobs\ThreadAvatarMessage;
use App\Jobs\ThreadLeftMessage;
use App\Jobs\ThreadNameMessage;
...
class SystemMessageSubscriber
{
    ...
    {
        $events->listen(NewSystemMessageEvent::class, [SystemMessageSubscriber::class, 'newSystemMessageEvent']);
     ...
     * @return void
     */
    public function newSystemMessageEvent(NewSystemMessageEvent $event): void
    {
        if ($this->isEnabled()) {
            $this->shouldQueue()
                ?
                SetupNewSystemMessage::dispatch($event)->onQueue(Messenger::getSystemMessageSubscriber('channel'))
                : SetupNewSystemMessage::dispatchSync($event);
        }
    }
